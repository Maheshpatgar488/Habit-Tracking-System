...
import { UserPlus, CalendarPlus, Users, Loader, ListTodo, CheckCircle, Clock, XCircle, Activity, TrendingUp, X, Trash2, Calendar, Sun, Sunrise, Moon } from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    return (
        <div className="animate-in fade-in duration-500 w-full relative z-0">
            ...
            {/* Inner layout wrapper. Moved space-y-8 here to prevent margin collapse at the boundary */}
